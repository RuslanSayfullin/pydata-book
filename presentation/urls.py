...
urlpatterns = [
    re_path(r'^(?P<reckoning_uuid>\w+)$', views.createupdateofferpage, name="create_update"),
    re_path(r'^(?P<reckoning_uuid>\w+)/addkitchenofferpage$', views.addkitchenofferpage, name="addkitchenofferpage"),
